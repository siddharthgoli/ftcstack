...
## Button Presses vs Holding

A button check runs continuously.
...
This runs every loop while the button is held.

For actions that happen once, use a toggle system.
